...
static_assert(!__reflect(query_has_automatic_local_storage, reflexpr(x)));
...
static_assert(!__reflect(query_has_automatic_local_storage, reflexpr(k)));
...
void local() {
  ...
  static_assert(__reflect(query_has_automatic_local_storage, reflexpr(y)));
}
