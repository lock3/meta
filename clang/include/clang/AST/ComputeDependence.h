...
class CXXInvalidReflectionExpr;
class CXXReflectionReadQueryExpr;
class CXXReflectionWriteQueryExpr;
class CXXReflectPrintLiteralExpr;
class CXXReflectPrintReflectionExpr;
class CXXReflectDumpReflectionExpr;
class CXXCompilerErrorExpr;
class CXXIdExprExpr;
class CXXMemberIdExprExpr;
class CXXDependentVariadicReifierExpr;
class CXXSelectionExpr;
class CXXDependentSpliceIdExpr;
class CXXValueOfExpr;
...
ExprDependence computeDependence(CXXReflectExpr *E);
ExprDependence computeDependence(CXXInvalidReflectionExpr *E);
ExprDependence computeDependence(CXXReflectionReadQueryExpr *E);
ExprDependence computeDependence(CXXReflectionWriteQueryExpr *E);
ExprDependence computeDependence(CXXReflectPrintLiteralExpr *E);
ExprDependence computeDependence(CXXReflectPrintReflectionExpr *E);
ExprDependence computeDependence(CXXReflectDumpReflectionExpr *E);
ExprDependence computeDependence(CXXCompilerErrorExpr *E);
ExprDependence computeDependence(CXXIdExprExpr *E);
ExprDependence computeDependence(CXXMemberIdExprExpr *E);
ExprDependence computeDependence(CXXDependentVariadicReifierExpr *E);
ExprDependence computeDependence(CXXSelectionExpr *E);
ExprDependence computeDependence(CXXDependentSpliceIdExpr *E);
ExprDependence computeDependence(CXXValueOfExpr *E);
