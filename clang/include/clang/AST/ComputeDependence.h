...
class CXXMemberExprSpliceExpr;
class CXXPackSpliceExpr;
...
ExprDependence computeDependence(CXXMemberExprSpliceExpr *E);
ExprDependence computeDependence(CXXPackSpliceExpr *E);
