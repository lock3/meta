...
class CXXDeclSpliceExpr;
class CXXMemberDeclSpliceExpr;
...
ExprDependence computeDependence(CXXDeclSpliceExpr *E);
ExprDependence computeDependence(CXXMemberDeclSpliceExpr *E);
