...
constexpr meta::info func_refl = ^foo;
...
constexpr meta::info class_refl = ^class_decl;
...
constexpr meta::info union_refl = ^union_decl;
...
constexpr meta::info enum_refl = ^enum_decl;
...
constexpr meta::info enum_class_refl = ^enum_class_decl;
...
constexpr meta::info void_type_refl = ^void;
...
constexpr meta::info nullptr_expr_refl = ^nullptr;
...
constexpr meta::info char_type_refl = ^char;
...
constexpr meta::info unsigned_char_type_refl = ^unsigned char;
...
constexpr meta::info short_type_refl = ^short;
...
constexpr meta::info unsigned_short_type_refl = ^unsigned short;
...
constexpr meta::info int_type_refl = ^int;
...
constexpr meta::info unsigned_int_type_refl = ^unsigned int;
...
constexpr meta::info long_type_refl = ^long;
...
constexpr meta::info unsigned_long_type_refl = ^unsigned long;
...
constexpr meta::info long_long_type_refl = ^long long;
...
constexpr meta::info unsigned_long_long_type_refl = ^unsigned long long;
...
constexpr meta::info float_type_refl = ^float;
...
constexpr meta::info double_type_refl = ^double;
...
constexpr meta::info long_double_type_refl = ^long double;
...
constexpr meta::info array_refl = ^arr;
...
constexpr meta::info ptr_refl = ^ptr;
...
constexpr meta::info lvalue_expr_refl = ^lvalue_var;
...
constexpr meta::info rvalue_expr_refl = ^rvalue_var;
...
constexpr meta::info member_obj_pointer_refl = ^&Container::memb_var;
...
constexpr meta::info member_fn_pointer_refl = ^&Container::memb_fn;
...
constexpr meta::info closure_refl = ^closure;
