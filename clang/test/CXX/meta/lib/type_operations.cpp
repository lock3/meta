...
constexpr meta::info constructible_class_refl = ^constructible;
static_assert(__reflect(query_is_constructible, constructible_class_refl));
static_assert(!__reflect(query_is_constructible, constructible_class_refl, ^int));
static_assert(!__reflect(query_is_trivially_constructible, constructible_class_refl));
static_assert(!__reflect(query_is_trivially_constructible, constructible_class_refl, ^int));
static_assert(!__reflect(query_is_nothrow_constructible, constructible_class_refl));
static_assert(!__reflect(query_is_nothrow_constructible, constructible_class_refl, ^int));
static_assert(__reflect(query_is_assignable, constructible_class_refl, constructible_class_refl));
static_assert(!__reflect(query_is_assignable, constructible_class_refl, ^int));
static_assert(!__reflect(query_is_trivially_assignable, constructible_class_refl, constructible_class_refl));
static_assert(!__reflect(query_is_trivially_assignable, constructible_class_refl, ^int));
static_assert(!__reflect(query_is_nothrow_assignable, constructible_class_refl, constructible_class_refl));
static_assert(!__reflect(query_is_nothrow_assignable, constructible_class_refl, ^int));
...
constexpr meta::info trivially_constructible_class_refl = ^trivially_constructible;
static_assert(__reflect(query_is_constructible, trivially_constructible_class_refl));
static_assert(!__reflect(query_is_constructible, trivially_constructible_class_refl, ^int));
static_assert(__reflect(query_is_trivially_constructible, trivially_constructible_class_refl));
static_assert(!__reflect(query_is_trivially_constructible, trivially_constructible_class_refl, ^int));
static_assert(__reflect(query_is_nothrow_constructible, trivially_constructible_class_refl));
static_assert(!__reflect(query_is_nothrow_constructible, trivially_constructible_class_refl, ^int));
static_assert(__reflect(query_is_assignable, trivially_constructible_class_refl, trivially_constructible_class_refl));
static_assert(!__reflect(query_is_assignable, trivially_constructible_class_refl, ^int));
...
static_assert(!__reflect(query_is_trivially_assignable, trivially_constructible_class_refl, ^int));
...
static_assert(!__reflect(query_is_nothrow_assignable, trivially_constructible_class_refl, ^int));
