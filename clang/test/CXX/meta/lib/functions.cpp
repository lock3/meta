...
constexpr meta::info function_refl = ^foo;
...
constexpr meta::info noexcept_function_refl = ^noexcept_foo;
...
constexpr meta::info noexcept_function_ptr_refl = ^noexcept_fn_type;
...
constexpr meta::info var_refl = ^x;
