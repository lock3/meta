...
constexpr info add_const = __reflect(query_add_const, ^int);
...
constexpr info add_volatile = __reflect(query_add_volatile, ^int);
...
constexpr info add_ptr = __reflect(query_add_pointer, ^int);
...
// make_signed
constexpr info make_signed = __reflect(query_make_signed, ^unsigned int);
static_assert(__reflect(query_is_signed_type, make_signed));
static_assert(!__reflect(query_is_unsigned_type, make_signed));

// make_unsigned
constexpr info make_unsigned = __reflect(query_make_unsigned, ^int);
...
constexpr info add_lref = __reflect(query_add_lvalue_reference, ^int);
...
constexpr info add_rref = __reflect(query_add_rvalue_reference, ^int);
