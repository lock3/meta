...
constexpr meta::info extern_fn_refl = ^extern_fn;
...
constexpr meta::info inline_fn_refl = ^inline_fn;
...
constexpr meta::info constexpr_fn_refl = ^constexpr_fn;
...
constexpr meta::info consteval_fn_refl = ^consteval_fn;
...
constexpr meta::info base_class_refl = ^base_class;
...
constexpr meta::info final_child_class_refl = ^child_class;
...
constexpr meta::info defined_fn_refl = ^defined_fn;
